...
const (
	...
	// RegionMXCentral1 represents the Mexico Region Queretaro
...
const (
	...
	// eksResourceAccountMXCentral1 defines the AWS EKS account ID that provides node resources in mx-central-1 region
